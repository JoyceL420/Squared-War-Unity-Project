...
public class unit : MonoBehaviour
{
    ...
    public void Initialize(int speed, int id, int team, List<int> movementPriority, (float x, float y) spawnPoint, List<(float, float)> obstructedSquares, string movementType)
    {
        _team = team;
        if (_team == 1)
        {
