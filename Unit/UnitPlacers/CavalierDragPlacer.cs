...
public class CavalierDragPlacer : MonoBehaviour
{
    ...
    void OnMouseUp()
    {
        ...
        transform.position = new Vector2(_cameraPosition.transform.position.x - 8.5f, _cameraPosition.transform.position.y - 4.3f);
    }
