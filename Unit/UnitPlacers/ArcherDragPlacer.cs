...
public class ArcherDragPlacer : MonoBehaviour
{
    ...
    void OnMouseUp()
    {
        ...
        transform.position = new Vector2(_cameraPosition.transform.position.x - 5.5f, _cameraPosition.transform.position.y - 4.3f);
    }
    ...
    {
        _teamsController.CloneArcher(xSpawnPoint, ySpawnPoint, _team);
    }
